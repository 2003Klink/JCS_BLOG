    ...
    <div className='grid grid-cols-1 justify-center bg-red w-full min-h-[40vh]'>
        ...
        <div className=' grid grid-cols-1 xl:grid-cols-3 justify-center items-center'>
            ...
            {topBlogger.map((item,index)=>{
                ...
                <div className='grid grid-cols-1 max-h-[50vh] min-h-[20vh] w-[90vw] xl:w-[25vw]  rounded-lg bg-white shadow-lg shadow-black'>
                ...
                <div className='grid justify-center items-center text-center text-black font-bold text-xl min-h-[20vh] text-3xl'>{item.bio}</div>
                <div className='grid justify-center items-center'>
                <a className='rounded-lg bg-red  hover:bg-red-400 py-4 px-16 mb-5' href={`/user#${item.id}`}><button className='shadow-2xl text-white font-bold'>Home</button></a>
                </div>
                </div>
            </div>
                )
