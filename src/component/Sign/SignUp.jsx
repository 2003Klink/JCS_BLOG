    ...
    return (
        ...
        <form className=" w-full  bg-gray my-6 p-10 rounded-2xl" onSubmit={(e) => {
            ...
            <div className="relative z-0 w-full md:w-[50vw] mb-5 group">
                <input onChange={(e) => { state.email = e.target.value; }} type="text" name="email" id="email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
